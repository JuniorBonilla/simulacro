...
public class cmo_sea extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cmo_sea);
        Que_Hacer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent uno = new Intent(cmo_sea.this,items_que_hacer.class);
                startActivity(uno);
            }
        });
        Que_Visitar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent uno = new Intent(cmo_sea.this,items_que_visitar.class);
                startActivity(uno);
            }
        });
        Donde_Dormir.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent uno = new Intent(cmo_sea.this,items_donde_dormir.class);
                startActivity(uno);
            }
        });
        Donde_Comer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent uno = new Intent(cmo_sea.this,items_donde_comer.class);
                startActivity(uno);
            }
        });
        Servicios_Turisticos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent uno = new Intent(cmo_sea.this,items_servicios_turisticos.class);
                startActivity(uno);
            }
        });
        Llamadas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent uno = new Intent(cmo_sea.this,items_llamadas.class);
                startActivity(uno);
            }
        });
